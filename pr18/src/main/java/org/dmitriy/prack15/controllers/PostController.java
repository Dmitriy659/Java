...
public class PostController {
    ...
    @GetMapping("/filterByCity/{cityName}")
    public List<PostOffice> filterCityName(@PathVariable String cityName) {
        return postOfficeService.filterPostOfficesByCity(cityName);
    }
}
